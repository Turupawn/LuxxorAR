...
public class Model3D extends ARObject implements Serializable{
	...
	protected HashMap<Material, Integer> textureIDs = new HashMap<Material, Integer>();
	
	public Model3D(Model model,String pattern_file) {
		super("model", pattern_file, 80.0, new double[]{0,0});
		this.model = model;
		model.finalize();
